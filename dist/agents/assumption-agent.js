...
class AssumptionAgent {
    ...
    async createForksForViolations(violations) {
        const forkedDecisions = [];
    ...
    isAssumptionViolated(assumption, newInfo) {
    ...
    calculateSeverity(assumption, newInfo) {
...
exports.AssumptionAgent = AssumptionAgent;
//# sourceMappingURL=assumption-agent.js.map